...
osc15 = os.osc(f1*15);
osc16 = os.osc(f1*16);
//vslider vuole 4 parametri: valore di inizializzazione, valore minimo, valore massimo, step incrementato.
fader = vslider ("volume", 0.0,0.0,2.0,0.1);
process = hgroup ("Mixer", osc1*(fader1),_*(fader2),_*(fader3),_*(fader4),_*(fader5),_*(fader6),_*(fader7),_*(fader8),_*(fader9),_*(fader10),_*(fader11),_*(fader12),_*(fader13),_*(fader14),_*(fader15),_*(fader16)): +,+,+,+,+,+,+,+ : +,+,+,+: +,+;
